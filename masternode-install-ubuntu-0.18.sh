...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='odinycoin.conf'
CONFIGFOLDER='/root/.odinycoin'
COIN_DAEMON='odinycoind'
COIN_CLI='odinycoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/odinyblockchain/odinycoin/releases/download/1.0.0/odc-v1.0.0-linux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='odinycoind'
COIN_EXPLORER='http://explorer.odinycoin.com'
COIN_PORT=1517
RPC_PORT=1516
